<?php
    ...
    //koneksi
    $connect  = new mysqli($db_host, $db_user, $db_pass, $db_user);
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET'){
        ...
        do {
            if (empty($npsn) || empty($status) ||empty($bentuk_pendidik) || empty($nama_sekolah) ||empty($sk_pendirian) ||empty(tgl_pendirian) || empty($sk_izin_operasional) ||empty($tgl_izin_operasional) || empty($alamat) || empty($rt) || empty($rw) || empty($dusun) ||empty($desa) || empty($kecamatan) || empty($kabupaten) || empty($provnsi)|| empty($kode_pos)){
                $errorMessage = "Periksa Data Anda yang Masih Salah!";
                break;
            }
    ...
    <div class="card m-3">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="sk_operasional" value="<?php echo $sk_izin_operasional; ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">Tanggal Izin Operasional</label>
                <div class="col-sm-6">
                    <input type="date" class="form-control" name="tgl_operasional" value="<?php echo $tgl_izin_operasional; ?>">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="/utscrud5/index.php" role="button">Cancel</a>
                </div>
            </div>
