...
<body>
    <div class="card m-3">
        ...
        <div class="container m-3">
            ...
            <a class="btn btn-primary" href="/utscrud5/create.php" role="button">Tambah Sekolah</a>
        <br>
            ...
            while($row = $result->fetch_assoc()){
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class='btn btn-primary btn-sm' href='/utscrud5/coba.php?npsn=$row[npsn]'>Edit</a>  
                    </td>
                    <td>
                        <a class='btn btn-dark btn-sm' href='/utscrud5/delete.php?npsn=$row[npsn]'>Delete</a>
                    </td>
              </tr>
                ";
            }
